...
const scheduleSchema = require("../schemas/schema.schedule");
const init = require("../init");

const scheduleCollection = init.modelNames.schedule;
const crud = new mongooseCrud(scheduleCollection, scheduleSchema, null);
